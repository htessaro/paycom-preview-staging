...
- [Holds and captures](/docs/payments/payment-concepts/holds-and-captures): authorization and capture flows in detail.
- [Refunds](/docs/payments/payment-concepts/refunds): how to return funds to customers.
- [Payouts](/docs/payments/payment-concepts/payouts): sending funds from your account to customers.
